...
/// }
/// ```
// Point d'extension : rien dans le fragment n'appelle cette garde, et un binaire
// n'exporte rien qui la tiendrait en vie. Retirez cette ligne dès qu'une de vos routes
// l'utilise — elle masquerait alors du code réellement mort.
#[allow(dead_code)]
// region: require_role
