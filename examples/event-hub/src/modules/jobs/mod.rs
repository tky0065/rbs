...
// Réexportées pour que le projet écrive `jobs::enqueue(&transaction, &job)` : tant
// qu'aucun handler ne le fait, le compilateur les tient pour inutiles.
#[allow(unused_imports)]
pub use queue::{enqueue, enqueue_at};
...
/// second appel — la balise fermante finit à une autre indentation que l'ouvrante, une
/// ancre que plus rien ne referme au bon endroit.
