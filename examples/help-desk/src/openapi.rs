...
#[openapi(
    ...
    paths(
        ...
        crate::tickets::controller::list,
        crate::tickets::controller::filter,
        crate::tickets::controller::create,
        crate::tickets::controller::find,
        crate::tickets::controller::update,
        crate::tickets::controller::delete,
        crate::commentaires::controller::list,
        crate::commentaires::controller::filter,
        crate::commentaires::controller::create,
        crate::commentaires::controller::find,
        crate::commentaires::controller::update,
        crate::commentaires::controller::delete,
        // </rbs:openapi>
    )
)]
pub struct ApiDoc;
