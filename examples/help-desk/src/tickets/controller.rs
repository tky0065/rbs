...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "page de tickets", body = Page<TicketResponse>),
...
) -> Result<Json<Page<TicketResponse>>> {
...
#[utoipa::path(
    ...
    request_body = TicketFilter,
    responses(
        (status = 200, description = "page de tickets filtrés", body = Page<TicketResponse>),
...
#[utoipa::path(
    ...
    responses(
        (status = 201, description = "ticket créé", body = TicketResponse),
...
#[utoipa::path(
    ...
    path = "/tickets/{id}",
    tag = "tickets",
    operation_id = "tickets_find",
    security(("bearer" = [])),
    params(("id" = Uuid, Path, description = "identifiant de ticket")),
    responses(
        (status = 200, description = "ticket demandé", body = TicketResponse),
        (status = 401, description = "jeton absent ou invalide", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 403, description = "rôle insuffisant", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 404, description = "ticket introuvable", body = ProblemDetails, content_type = "application/problem+json")
    )
)]
pub async fn find(
    State(state): State<AppState>,
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "ticket mis à jour", body = TicketResponse),
        (status = 401, description = "jeton absent ou invalide", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 403, description = "rôle insuffisant", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 404, description = "ticket introuvable", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 409, description = "valeur déjà prise sur une colonne unique", body = ProblemDetails, content_type = "application/problem+json")
...
#[utoipa::path(
    ...
    params(("id" = Uuid, Path, description = "identifiant de ticket")),
    responses(
        (status = 204, description = "ticket supprimé"),
        (status = 401, description = "jeton absent ou invalide", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 403, description = "rôle insuffisant", body = ProblemDetails, content_type = "application/problem+json"),
        (status = 404, description = "ticket introuvable", body = ProblemDetails, content_type = "application/problem+json")
    )
