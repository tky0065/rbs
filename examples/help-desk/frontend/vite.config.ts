...
// routes que le squelette monte — sonde de santé, interface et document OpenAPI — puis
// celles que le projet ajoute.
//
// Sans ce relais, l'appel partirait sur le port de Vite et rendrait l'application en
// retour. `rbs generate crud` inscrit lui-même le préfixe de chaque table qu'il engendre
// dans l'ancre ci-dessous ; une route écrite à la main se déclare à côté, à la main.
const RELAYE = [
  '/health',
  '/docs',
  '/api-docs',
