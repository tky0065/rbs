...
async fn the_full_lifecycle_goes_through_the_api() {
    ...
    compare(&created, &sent, "reference");
    compare(&created, &sent, "sujet");
    compare(&created, &sent, "detail");
    compare(&created, &sent, "gravite");
    compare(&created, &sent, "ouvert");
    compare(&created, &sent, "duree_minutes");
    compare(&created, &sent, "echeance");
    filled(&created, "constate_le");
    ...
    compare(&updated, &sent, "reference");
    compare(&updated, &sent, "sujet");
    compare(&updated, &sent, "detail");
    compare(&updated, &sent, "gravite");
    compare(&updated, &sent, "ouvert");
    compare(&updated, &sent, "duree_minutes");
    compare(&updated, &sent, "echeance");
