...
fn creation() -> Value {
    ...
    json!({
        "reference": format!("reference-{suffix}"),
        "sujet": format!("sujet-{suffix}"),
        "detail": format!("detail-{suffix}"),
        "gravite": "basse",
        "ouvert": true,
        "duree_minutes": 42,
        "echeance": "2024-01-15",
        "constate_le": chrono::Utc::now().to_rfc3339(),
    })
}
...
fn modification() -> Value {
    ...
    json!({
        "reference": format!("reference-modifie-{suffix}"),
        "sujet": format!("sujet-modifie-{suffix}"),
        "detail": format!("detail-modifie-{suffix}"),
        "gravite": "moyenne",
        "ouvert": false,
        "duree_minutes": 43,
        "echeance": "2024-06-20",
