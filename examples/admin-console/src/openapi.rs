...
#[openapi(
    ...
    paths(
        ...
        crate::incidents::controller::list,
        crate::incidents::controller::filter,
        crate::incidents::controller::create,
        crate::incidents::controller::find,
        crate::incidents::controller::update,
        crate::incidents::controller::delete,
        // </rbs:openapi>
    )
)]
pub struct ApiDoc;
