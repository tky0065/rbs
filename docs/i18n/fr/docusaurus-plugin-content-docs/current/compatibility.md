...
vingt-et-une ancres en commentaires — seize en Rust, `// <rbs:features>`,
...
deux hors des deux, au marqueur de commentaire `#` de Git : `# <rbs:services>` dans
...
juste à côté — le nom de la table tenant lieu du nom fixe que portent les vingt-et-une
ci-dessus, puisqu'un même fichier peut porter plusieurs entités. Elles sortent du compte
des vingt-et-une parce que le fichier qui les porte dépend des features du projet, non du
...
- les vingt-et-un noms d'ancres et leur syntaxe de commentaire ne changent pas, non plus que la
...
vérifie toutes les vingt-et-une — treize sur un projet qui ne porte ni file, ni calendrier,
ni authentification, ni client, ni shell d'administration, dix des vingt-et-une étant
