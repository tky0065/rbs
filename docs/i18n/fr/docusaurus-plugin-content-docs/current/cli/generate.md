...
Il n'y en a pas un dixième, ni de type `email` : un format de chaîne n'est pas un type de
colonne.
...
Le neuvième, `references`, n'est pas un scalaire du tout : il pointe la colonne vers une
