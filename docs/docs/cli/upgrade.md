...
It writes to `Cargo.toml` and to nothing else. The rest of the project — controllers,
configuration, migrations — is yours from the moment [`rbs new`](./new.md) put it there,
and re-rendering it on a newer version would erase your work without you having asked for
it by name.
...
That is the whole of it, and it is what makes the promise of [the compatibility
