...
generate`](./generate.md#anchors) that inserts into the project's nine comment anchors —
`// <rbs:features>`, `// <rbs:routes>`, `// <rbs:openapi>`, `// <rbs:migration_modules>`,
`// <rbs:migrations>`, `// <rbs:state_champs>`, `// <rbs:state_init>`, `// <rbs:startup>` and `// <rbs:seeds>`.
...
[`rbs doctor`](./doctor.md) checks all nine.
